...
#2. NUMARA TAHMİNİ
x_train = train_data[['Yıl', '1. numara']]
y_train = train_data['2. numara']

x_test = test_data[['Yıl', '1. numara']]
...
#3. NUMARA TAHMİNİ
x_train = train_data[['Yıl', '1. numara', '2. numara']]
y_train = train_data['3. numara']

x_test = test_data[['Yıl', '1. numara', '2. numara']]
...
#4. NUMARA TAHMİNİ
x_train = train_data[['Yıl', '1. numara', '2. numara', '3. numara']]
y_train = train_data['4. numara']

x_test = test_data[['Yıl', '1. numara', '2. numara', '3. numara']]
...
#5. NUMARA TAHMİNİ
x_train = train_data[['Yıl', '1. numara', '2. numara', '3. numara', '4. numara']]
y_train = train_data['5. numara']

x_test = test_data[['Yıl', '1. numara', '2. numara', '3. numara', '4. numara']]
...
#6. NUMARA TAHMİNİ
x_train = train_data[['Yıl', '1. numara', '2. numara', '3. numara', '4. numara', '5. numara']]
y_train = train_data['6. numara']

x_test = test_data[['Yıl', '1. numara', '2. numara', '3. numara', '4. numara', '5. numara']]
...
#7. NUMARA TAHMİNİ
x_train = train_data[['Yıl', '1. numara', '2. numara', '3. numara', '4. numara', '5. numara', '6. numara']]
y_train = train_data['7. numara']

x_test = test_data[['Yıl', '1. numara', '2. numara', '3. numara', '4. numara', '5. numara', '6. numara']]
